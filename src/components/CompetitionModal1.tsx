...
interface CompetitionModal1Props {
  handleClose: () => void;
  open: boolean;
}
...
const CompetitionModal1: React.FC<CompetitionModal1Props> = ({
  handleClose,
  open,
}) => {
          ...
          >
            <div className="mb-4">
              ...
              <input
                ...
                className="bg-gray-200 appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-[#5B1CD4]"
              />
            </div>
            ...
            <div className="text-center">
              <button
                type="submit"
                className="bg-[#5B1CD4] hover:bg-purple-600 font-[Montserrat] text-white font-bold py-2 px-8 rounded-md focus:outline-none focus:shadow-outline"
              >
                Submit
              </button>
            </div>
...
export default CompetitionModal1;
